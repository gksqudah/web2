...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand ./resources/js2-scroll-trigger" href="#page-top">AI World</a>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <a class="btn btn-light btn-xl ./resources/js2-scroll-trigger" href="#services">Get Started!</a>
                    </div>
                </div>
            </div>
        </section>
